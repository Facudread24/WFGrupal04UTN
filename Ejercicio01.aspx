...
<body>
    <form id="form1" runat="server">
        <div>
        <p>DESTINO INICIO</p>
            <p>PROVINCIA:<asp:DropDownList ID="ddl_prov_ini" runat="server" OnSelectedIndexChanged="ddl_prov_ini_SelectedIndexChanged">
				</asp:DropDownList>
			</p>
            ...
            <p>DESTINO FINAL</p>
            <p>PROVINCIA:<asp:DropDownList ID="ddl_prov_fin" runat="server">
				</asp:DropDownList>
			</p>
